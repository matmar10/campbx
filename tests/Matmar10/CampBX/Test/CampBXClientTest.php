...
class CampBXClientTest extends GuzzleTestCase
{
    ...
    public function testGetMarketDepth($response, $expectedCurrentAskMultiplier, $expectedCurrentBidMultiplier)
    {
        ...
        $this->assertEquals($expectedCurrentAskMultiplier, $ask->getMultiplier());
        $this->assertInstanceOf('\\Matmar10\\Money\\Entity\\Money', $ask->getDepth());
        ...
        $bidCollection = $result->get('bid');
        $this->assertInstanceOf('\\Matmar10\\Money\\CurrencyExchange\\Entity\\MarketDepthCollectionInterface', $bidCollection);
        $bid = current($bidCollection->getBids());
        $this->assertInstanceOf('\\Matmar10\\Money\\CurrencyExchange\\Entity\\MarketDepthPrice', $bid);
        ...
        $this->assertEquals($expectedCurrentBidMultiplier, $bid->getMultiplier());
        $this->assertInstanceOf('\\Matmar10\\Money\\Entity\\Money', $bid->getDepth());
